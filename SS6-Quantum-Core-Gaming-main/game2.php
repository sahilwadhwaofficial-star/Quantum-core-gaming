...
<head>
    ...
    <img class="echoes5" src="echoes5.jpeg">
    <h1 class="big-shoulders-stencil-text-content"
        style="color: whitesmoke; text-align:center;text-decoration: underline;">ECHOES OF ETERNITY</h1><br>
    <br>
    <div style="display: flex;">
        <div style="display: inline;">
            <p class="saira-stencil-one-regular" style="color: whitesmoke; margin-left: 2cm;">STEP INTO A WORLD WHERE TIME IS BROKEN</p>
            <p class="saira-stencil-one-regular" style="color: whitesmoke;margin-left: 2cm">Echoes of Eternity" immerses players in a medieval world shattered by The Great Disruption,</p>
            <p class="saira-stencil-one-regular" style="color: whitesmoke;margin-left: 2cm">an event that has fragmented time itself.</p>
            <p class="saira-stencil-one-regular" style="color: whitesmoke;margin-left: 2cm">As a temporal archaeologist, you will explore breathtaking medieval environments, manipulate time loops, and uncover the secrets of a fractured reality</p>
            <p class="saira-stencil-one-regular" style="color: whitesmoke;margin-left: 2cm">Can you repair the timeline and escape the loop, or will you become a victim of eternity?</p>
        </div>
        <div style="display: inline;">
            <img src="echoes.jpeg" class="echoes_poster">
        </div>
    </div>
    <h2 class="big-shoulders-stencil-text-content" style="color: whitesmoke; text-align:center;margin: 50px;">EXPERIENCE THE POWER OF TIME
    </h2>
    <div class="features">
        <div class="div1"></div>
        <div class="feat1">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="big-shoulders-stencil-text-content">Dynamic Time Loop Mechanics: Shape outcomes and retry scenarios to master challenges</h4>
        </div>
        <div class="div2"></div>
        <div class="feat2">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="big-shoulders-stencil-text-content">Stunning Temporal Effects: Witness time dilation, wormholes, and paradoxes in breathtaking detail.
            </h4>
        </div>
        <div class="div3"></div>
        <div class="feat3">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="big-shoulders-stencil-text-content">Exploration and Discovery: Traverse medieval ruins, uncover artifacts, and piece together the story of The Great Disruption.
            </h4>
        </div>
        <div class="div4"></div>
        <div class="feat4">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="big-shoulders-stencil-text-content">Choice-Driven Narrative: Your decisions affect the timeline and determine the fate of the world.</h4>
        </div>
    </div><br>
    ...
    <form action="process_purchase.php" method="post">
        ...
        <label>
            <h5 class="saira-stencil-one-regular">AMOUNT PAYABLE : RS.1500/-</h5>
        </label><br>

        <input type="hidden" name="product_name" value="Echoes of Eternity">
