...
<body>
  ...
  <nav>
    ...
    <img class="echoes5" src="voices5.jpeg">
    <h1 class="trade-winds-regular"
        style="color: whitesmoke; text-align:center;text-decoration: underline;">VOICES OF THE WILD</h1><br>
    <br>
    <div style="display: flex;">
        <div style="display: inline;">
            <br><br><br>
            <h3 class="trade-winds-regular" style="color: whitesmoke; margin-left: 2cm;">The forest whispers its secrets. Can you survive the truth?</h3>
            <h3 class="trade-winds-regular" style="color: whitesmoke;margin-left: 2cm">Voices of the Wild" is a survival horror game that plunges you into the heart of an ancient, sentient forest. </h3>
            <h3 class="trade-winds-regular" style="color: whitesmoke;margin-left: 2cm">Trapped within its eerie boundaries, you must navigate through dense trees, unravel cryptic mysteries,</h3>
            <h3 class="trade-winds-regular" style="color: whitesmoke;margin-left: 2cm">and confront the terrifying entities that call this place home.</h3>
            <h3 class="trade-winds-regular" style="color: whitesmoke;margin-left: 2cm">The forest speaks, but are you ready to listen?"</h3>
        </div>
        <div style="display: inline;">
            <img src="voices_of_wild.webp" class="echoes_poster">
        </div>
    </div>
    <h2 class="trade-winds-regular" style="color: whitesmoke; text-align:center;margin: 50px;">Survive the Forest. Uncover Its Secrets.
    </h2>
    <div class="features">
        <div class="div1"></div>
        <div class="feat1">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="trade-winds-regular">The forest speaks in whispers, guiding or deceiving you as you explore.</h4>
        </div>
        <div class="div2"></div>
        <div class="feat2">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="trade-winds-regular">Scavenge for resources, craft tools, and light your path through the darkness.
            </h4>
        </div>
        <div class="div3"></div>
        <div class="feat3">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="trade-winds-regular">No two playthroughs are the same; the forest evolves with each step
            </h4>
        </div>
        <div class="div4"></div>
        <div class="feat4">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="trade-winds-regular">Feel the tension build with spine-chilling visuals and a haunting soundtrack</h4>
        </div>
    </div><br>
    ...
    <form action="process_purchase.php" method="post">
        ...
        <label>
            <h5 class="saira-stencil-one-regular">AMOUNT PAYABLE : RS.2500/-</h5>
        </label><br>

        <input type="hidden" name="product_name" value="Voices of the Wild">
