...
<link href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Stencil+Text:wght@100..900&family=Saira+Stencil+One&family=Trade+Winds&display=swap" rel="stylesheet">
...
<body>
  ...
  <nav>
    ...
    <img class="echoes5" src="truth5.jpeg">
    <h1 class="saira-stencil-one-regular"
        style="color: whitesmoke; text-align:center;text-decoration: underline;">FRACTURED TRUTH</h1><br>
    <br>
    <div style="display: flex;">
        <div style="display: inline;">
            <br><br><br>
            <h3 class="saira-stencil-one-regular" style="color: whitesmoke; margin-left: 2cm;">Step Into a City Where Truth Is a Lie</h3>
            <h3 class="big-shoulders-stencil-text-content" style="color: whitesmoke;margin-left: 2cm">In a world where memories can be altered and reality is subjective,</h3>
            <h3 class="big-shoulders-stencil-text-content" style="color: whitesmoke;margin-left: 2cm">you play as Detective Ren Carter, tasked with unraveling a conspiracy that threatens the fabric of society.</h3>
            <h3 class="big-shoulders-stencil-text-content" style="color: whitesmoke;margin-left: 2cm">'Fractured Truth' is a narrative-driven game where every decision reshapes the story,</h3>
            <h3 class="big-shoulders-stencil-text-content" style="color: whitesmoke;margin-left: 2cm">leading to multiple endings and countless paths to explore.</h3>
        </div>
        <div style="display: inline;">
            <img src="fractured_truth2.jpeg" class="truth_poster">
        </div>
    </div>
    <h2 class="saira-stencil-one-regular" style="color: whitesmoke; text-align:center;margin: 50px;">Uncover the lies. Alter the truth. Rewrite the future.
    </h2>
    <div class="features">
        <div class="div1"></div>
        <div class="feat1">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="saira-stencil-one-regular">Your choices matter. Every decision alters the story, leading to unique outcomes.</h4>
        </div>
        <div class="div2"></div>
        <div class="feat2">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="saira-stencil-one-regular">Explore a stunningly detailed futuristic city filled with secrets and danger.
            </h4>
        </div>
        <div class="div3"></div>
        <div class="feat3">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="saira-stencil-one-regular">Use cutting-edge technology to uncover altered memories and reveal hidden truths.
            </h4>
        </div>
        <div class="div4"></div>
        <div class="feat4">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="saira-stencil-one-regular">Experience a replayable story with diverse conclusions based on your path.</h4>
        </div>
    </div><br>
    ...
    <form action="process_purchase.php" method="post">
        ...
        <label>
            <h5 class="saira-stencil-one-regular">AMOUNT PAYABLE : RS.3000/-</h5>
        </label><br>

        <input type="hidden" name="product_name" value="Fractured Truth">
