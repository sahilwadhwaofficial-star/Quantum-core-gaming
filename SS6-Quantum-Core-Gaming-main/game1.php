...
<body>
    ...
    <img class="play_fest" src="playfest2.png">
    <h1 class="big-shoulders-stencil-text-content"
        style="color: whitesmoke; text-align:center;text-decoration: underline;">Welcome to Quantum PlayFest:<br> Where
        Gaming Legends Are Born! </h1><br>
    <br>
    <div style="display: flex;">
        <div style="display: inline;">
            <p class="bruno-ace-sc-regular" style="color: whitesmoke; margin-left: 2cm;">Quantum PlayFest is your
                ultimate
                gateway to the
                gaming universe.</p>
            <p class="bruno-ace-sc-regular" style="color: whitesmoke;margin-left: 2cm">Hosted by
                Quantum Core Gaming,</p>
            <p class="bruno-ace-sc-regular" style="color: whitesmoke;margin-left: 2cm">this annual event brings
                together
                players,
                developers, and creators for a celebration
                of
                gaming excellence.</p>
            <p class="bruno-ace-sc-regular" style="color: whitesmoke;margin-left: 2cm">Whether you're here to
                compete,
                learn, or simply enjoy, </p>
            <p class="bruno-ace-sc-regular" style="color: whitesmoke;margin-left: 2cm">PlayFest is where legends
                are
                made!</p>
        </div>
        <div style="display: inline;">
            <img src="playfest3.png" class="playfest3">
        </div>
    </div>
    <h2 class="big-shoulders-stencil-text-content" style="color: whitesmoke; text-align:center;margin: 50px;">Join us
        for the ultimate
        online gaming
        festival, brought to you by Quantum Core Gaming. Compete, connect, and conquer in an epic celebration of gaming!
    </h2>
    <div class="features">
        <div class="div1"></div>
        <div class="feat1">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="bruno-ace-sc-regular">Take part in intense
                multiplayer<br> tournaments<br> across various game genres.</h4>
        </div>
        <div class="div2"></div>
        <div class="feat2">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="bruno-ace-sc-regular">Network with fellow <br>Gamers, <br>Streamers, and
                <br>Developers.
            </h4>
        </div>
        <div class="div3"></div>
        <div class="feat3">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="bruno-ace-sc-regular">Amazing prizes,<br> exclusive merch,<br> and bragging rights!
            </h4>
        </div>
        <div class="div4"></div>
        <div class="feat4">
            <h4 style="color: whitesmoke;text-align: center;margin-top: 2cm;"
                class="bruno-ace-sc-regular">Witness<br> game demos,<br> early access content,<br> and
                developer Q&A
                sessions.</h4>
        </div>
    </div><br>
    ...
    <center>
        <div style="align-items: center;">
            <button class="btn btn-primary bruno-ace-sc-regular" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">REGISTER NOW</button>

            <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
                id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                <div class="offcanvas-header">
                    <h2 class="offcanvas-title big-shoulders-stencil-text-content" id="offcanvasScrollingLabel">SIGN UP
                        NOW!</h2>
                ...
                <div class="offcanvas-body">
                    <form action="process_registration.php" method="post">
                        <label>
                            <h5 class="saira-stencil-one-regular">ENTER FULL NAME-</h5>
                        </label><br>
                        <input style="width: 9cm; border-radius: 20px;" type="text" id="name" placeholder="ENTER NAME" class="bruno-ace-sc-regular" name="full_name" required><br><br>
                        ...
                        <label>
                            <h5 class="saira-stencil-one-regular">ENTER E-MAIL ID-</h5>
                        </label><br>
                        <input style="width: 9cm; border-radius: 20px;" type="text" id="email" class="bruno-ace-sc-regular" placeholder="ENTER E-MAIL ID" name="email" required><br><br>
                        
                        <script>
                            function validateForm() {
                                    // Get the input fields
                                    let name = document.getElementById('name');
                                    let gamerTag = document.getElementById('gtag');
                                    ...
                                    alert("Congratulations " + gamerTag.value + "! Registration Successful!");
                                    return true;
                                }
                            </script>
                        <input type = "submit" onclick = validateForm() value="Submit" class = "btn btn-primary bruno-ace-sc-regular" style="background-color: blueviolet;">
                    </form>
                </div>
            </div>
        </div>
