    ...
    <div class = "main_grid">
        <div class="div1 ">
            ...
            <div class="masked-image-wrapper">
                <img src="p2.png" class="play">
            </div>
        
            <!-- Separate container for text content -->
            <div class="text-content">
                <div class = "pass"></div>
                <h1 align="left" class="bungee-spice-regular resize">Quantum Pass</h1>
                
                <br>
                <h6 class="quantum-pass-description bruno-ace-sc-regular ">
                    Quantum Pass Ultimate includes online console <br>
                    multiplayer and hundreds of high-quality games.<br>
                    Play games with friends on console and PC and get <br>
                    an EA Play membership – all for one low monthly price.
                </h6>
            ...
            <div>
                <br>
                <br>
                <h1 align = "center" class="bungee-spice-regular resize" style = "transform: translateY(-150px);">UPCOMING GAMES</h1>
            </div>
        
        </div>
            <div class = "sub_1 resize">
                <h6 class="bruno-ace-sc-regular st_font">Wars of World 2</h6>
            </div>
            <div class = "sub_2 resize">
                <h6 class="bruno-ace-sc-regular st_font">Dynasty of R.O.B.O.T.R.O.N</h6>
            </div>
        </div>
    </div>
    <br><br>
